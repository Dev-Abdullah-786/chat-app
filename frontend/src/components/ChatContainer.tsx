...
const ChatContainer = () => {
  const { selectedUser, setSelectedUser, messages, sendMessages, getMessages } =
    useChat();
  ...
  return selectedUser !== null ? (
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      <div className="flex items-center gap-3 py-3 mx-4 border-b border-stone-500">
        <img
          src={
            selectedUser?.profileImage instanceof File
          ...
          >
            ...
            <div className="text-center text-xs">
              <img
                src={
                  msg.senderId === authUser?._id
                    ? authUser?.profileImage instanceof File
                      ? URL.createObjectURL(authUser.profileImage)
